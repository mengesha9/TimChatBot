...
export default function Header({ setIsSidebarOpen, isSidebarOpen, isRightSidebarOpen, setIsRightSidebarOpen }) {
  ...
  return (
    <header className="bg-[#1C1E21] px-4 py-3">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          <h1 className="text-xl font-semibold text-gray-100">NetSuite RAG</h1>
        </div>
